...
create table produtos (
    ...
    select nome, email from clientes where sexo= "F";
    update produtos set observação = null where id = 1;
    select observação from produtos where id= 1;
    select * from produtos where observação <> '';
    
update clientes set email= 'marcelolocoloco@outlook.com', nome='Marcelo Rossi' where id= 1;

  
    select nome, email from clientes where bairro='Agua verde';
    
 select * from clientes where nome !='Marcelo Rossi' and nome !='Angelica';
